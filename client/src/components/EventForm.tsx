...
export default function EventForm() {
    ...
    return (
        <div className='container mx-auto px-4 sm:px-8 md:px-16 lg:px-24'>
            <h2 className='text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold'>Add Event</h2>
            <form className='space-y-4' ref={ref} action={async (FormData) => {
                ...
                <button type='submit' className='inline-flex justify-center py-2 px-4 sm:px-6 md:px-8 lg:px-10 border border-transparent shadow-sm text-sm sm:text-base md:text-lg lg:text-xl font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700'>Submit</button>            </form>
        </div>
    );
};